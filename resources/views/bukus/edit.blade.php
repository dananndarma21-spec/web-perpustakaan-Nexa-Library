<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto space-y-8">
        <div class="glass-card p-8">
            <form method="POST" action="{{ route('bukus.update', $buku) }}" class="space-y-6" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    @if($buku->gambar)
                        <div class="mb-3 flex items-center gap-4">
                            <img src="{{ asset('storage/' . $buku->gambar) }}" alt="{{ $buku->judul }}" class="w-20 h-28 object-cover rounded-xl border border-white/10 shadow-lg">
