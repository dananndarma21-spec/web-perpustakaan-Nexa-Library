...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <a href="<?php echo e(route('peminjamans.create')); ?>" class="btn-primary group">
    ...
    <div class="space-y-8">
        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-5">
            ...
            <div class="glass-panel group relative overflow-hidden transition-all duration-300 hover:scale-[1.03] hover:shadow-[0_20px_60px_rgba(139,92,246,0.08)]">
                <div class="relative z-10">
                    ...
                    <h3 class="mt-2 text-3xl font-bold text-white"><?php echo e($stats['total']); ?></h3>
                </div>
            ...
            <div class="glass-panel group relative overflow-hidden transition-all duration-300 hover:scale-[1.03]">
                <div class="relative z-10">
                    ...
                    <h3 class="mt-2 text-3xl font-bold text-white"><?php echo e($stats['dipinjam']); ?></h3>
                </div>
            ...
            <div class="glass-panel group relative overflow-hidden transition-all duration-300 hover:scale-[1.03]">
                <div class="relative z-10">
                    ...
                    <h3 class="mt-2 text-3xl font-bold text-white"><?php echo e($stats['dikembalikan']); ?></h3>
                </div>
            ...
            <div class="glass-panel group relative overflow-hidden transition-all duration-300 hover:scale-[1.03]">
                <div class="relative z-10">
                    ...
                    <h3 class="mt-2 text-3xl font-bold text-white <?php echo e($stats['terlambat'] > 0 ? 'text-rose-400' : ''); ?>"><?php echo e($stats['terlambat']); ?></h3>
                </div>
            ...
            <div class="glass-panel group relative overflow-hidden transition-all duration-300 hover:scale-[1.03]">
                <div class="relative z-10">
                    ...
                    <h3 class="mt-2 text-2xl font-bold text-white <?php echo e($stats['total_denda'] > 0 ? 'text-fuchsia-300' : ''); ?>">
                        Rp <?php echo e(number_format($stats['total_denda'], 0, ',', '.')); ?>
        ...
        <div class="space-y-4">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between px-1">
                ...
                <form action="<?php echo e(route('peminjamans.index')); ?>" method="GET" class="relative max-w-sm">
                    ...
                    <table class="w-full text-left" id="peminjaman-table">
                        ...
                        <tbody class="divide-y divide-white/[0.04]">
                            <?php $__empty_1 = true; $__currentLoopData = $peminjamans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="table-row group <?php echo e($p->computed_status === 'terlambat' ? 'table-row-late' : ''); ?>"
                                    id="peminjaman-row-<?php echo e($p->id); ?>">

                                    
                                    <td class="table-cell font-mono text-xs text-slate-500">#<?php echo e($p->id); ?></td>

                                    
                                    <td class="table-cell">
                                        <div class="font-semibold text-white"><?php echo e($p->siswa->nama); ?></div>
                                        <div class="text-xs text-slate-400"><?php echo e($p->siswa->nis); ?></div>
                                    </td>

                                    
                                    <td class="table-cell">
                                        <div class="font-medium text-slate-200"><?php echo e($p->buku->judul); ?></div>
                                    </td>

                                    
                                    <td class="table-cell">
                                        <span class="text-xs text-slate-400"><?php echo e($p->tanggal_pinjam->format('d M Y')); ?></span>
                                    </td>

                                    
                                    <td class="table-cell">
                                        <?php if($p->tanggal_kembali): ?>
                                            <span class="text-xs <?php echo e($p->computed_status === 'terlambat' ? 'text-rose-400 font-bold' : 'text-slate-400'); ?>">
                                    ...
                                    <td class="table-cell">
                                        <?php if($p->tanggal_pengembalian): ?>
                                            <span class="text-xs text-emerald-400 font-medium">
                                                <?php echo e($p->tanggal_pengembalian->format('d M Y')); ?>
                                    ...
                                    <td class="table-cell">
                                        <?php if($p->computed_status === 'terlambat'): ?>
                                        ...
                                        <?php elseif($p->computed_status === 'dipinjam'): ?>
                                    ...
                                    <td class="table-cell">
                                        <div class="font-bold <?php echo e($p->computed_denda > 0 ? 'text-rose-400' : 'text-slate-500'); ?>">
                                            Rp <?php echo e(number_format($p->computed_denda, 0, ',', '.')); ?>

                                        </div>
                                        <?php if($p->computed_status === 'terlambat' && $p->hari_terlambat > 0): ?>
                                            <div class="text-[10px] text-rose-400/70 mt-0.5">
                                                <i class="fa-regular fa-clock mr-0.5"></i><?php echo e($p->hari_terlambat); ?> hari × Rp 5.000
                                            </div>
                                        <?php elseif($p->computed_status === 'dikembalikan' && $p->computed_denda > 0): ?>
                                            <button type="button"
                                                onclick="bayarDenda('<?php echo e($p->id); ?>', '<?php echo e(route('peminjamans.bayar-denda', $p)); ?>')"
                                    ...
                                    <td class="table-cell text-right">
                                        <div class="flex justify-end gap-2 opacity-70 group-hover:opacity-100 transition-opacity duration-200">
                                            <a href="<?php echo e(route('peminjamans.edit', $p)); ?>" class="btn-edit">
                                                <i class="fa-solid fa-pen-to-square"></i> Edit
                                            </a>
                                            <button type="button" class="btn-delete"
                                                onclick="confirmDelete('<?php echo e(route('peminjamans.destroy', $p)); ?>', 'peminjaman-row-<?php echo e($p->id); ?>')">
                                ...
                                <tr>
                                    <td colspan="9" class="py-16 text-center">
                                        <div class="flex flex-col items-center gap-3">
                                            ...
                                            <a href="<?php echo e(route('peminjamans.create')); ?>" class="text-violet-400 text-xs hover:text-violet-300 transition-colors">
...
<?php /**PATH C:\Users\Danan\Downloads\TUGAS-MIGRATION4\TUGAS-MIGRATION\resources\views/peminjamans/index.blade.php ENDPATH**/ ?>